...
# var--             decreae the value in var by 1 
# %                 modulus division (return the remainder after division)

# There are several ways to perform arithmetic.

# 1. Use let bult in function. It follows the format:
...
# expr follow the format: 
# exp item1 operator item2 
expr 5 + 4 
expr 11 % 2 
...
# If you want to get the ength of a variable (how many characters),
